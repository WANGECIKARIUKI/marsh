...
import browser7 from '../components/images/browser7.jpeg';
...
function Browser() {
  ...
  return (
    <>
    <section className="hero" style={{ backgroundImage: `url(${browser7})` }}>
      <div className="content">
        <h1 style = {{padding: "20px"}}>Internet History Monitor.</h1>
        <ul class ="list-coil-hook-black pt-2">
          {" "}

<li>Real-time alerts: Receive instant notifications for any suspicious activity.</li>

<li>Find out if your children, partners or siblings are surfing safely and responsibly.</li>

<li>With just a few clicks you'll see the most visited website.</li>

<li>Redspy helps you filter the content you don't want them to browse.</li>

<li>You will be able to see the history of each web page they have visited.</li>
...
navigate("/Signup");}} >Get Started</button>
    ...
    <div className="content7">
      <Container id = "features">
        <h1> How to Track the Browser History on Android</h1>
        <Cards>
        ...
        disc = {"You can now access the account and track the website history of the target device.Follow the instructions on how to view the history,"}/>
  ...
  <section className="hero7" style={{ backgroundColor: "lightblue" }}>
    <div className="content7">
      <Container id = "features">
        <h1> How to Track the Browser History on iPhone</h1>
        <Cards>
        ...
        Icon = {Bs2SquareFill }
        title = {"Set up RedSpy"}
        disc={"When monitoring bookmarks and browsing history on an iPhone, you will need to connect Redspy to the device by providing the iCloud login details on the target device. Once you are done with inputting the email and password press continue to proceed to the last step."}/>

        <Card 
        Icon = {Bs3SquareFill}
        title = {"Start Monitoring"}
        disc = {"Access the browsing history section and easily view all the visited websites."}/>
